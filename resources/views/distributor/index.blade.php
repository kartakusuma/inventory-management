        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <a href="{{ route('distributors.create') }}" class="btn btn-primary">Add New Distributor</a>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
              <table id="myTable" class="table table-bordered table-striped">
                ...
                @foreach ($distributors as $distributor)
                    ...
                    <div class="modal fade" id="modal-delete{{ $distributor->id }}">
                        <div class="modal-dialog">
                          <div class="modal-content bg-danger">
                            ...
                            <div class="modal-body">
                              <p>Are you sure to delete <b>{{ $distributor->name }}</b> data</p>
                            </div>
                            <div class="modal-footer justify-content-between">
                              <button type="button" class="btn btn-outline-light" data-dismiss="modal">Close</button>
                              <form action="{{ route('users.destroy', $distributor->id) }}" method="post">
                                @csrf
                                @method('DELETE')
